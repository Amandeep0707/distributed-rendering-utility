...
class Footer(ctk.CTkFrame):
    def __init__(self, master=None, **kwargs):
        ...
        self.browse_button = ctk.CTkButton(self.blender_frame, text="Browse")
        ...
        self.render_button = ctk.CTkButton(self.frame, height=40, font=ctk.CTkFont(size=15, weight="bold"), text="Render All")
        self.render_button.pack(fill="x", padx=5, pady=5)